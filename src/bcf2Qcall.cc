...
void writeToSNPObject(qcall_t *mom_snp, bcf1_t *b, bcf_hdr_t *h, int *g, int d,
...
void writeToIndelObject(indel_t *mom_indel, bcf1_t *b, bcf_hdr_t *h, int *g,
...
int bcf_2qcall(bcf_hdr_t *h, bcf1_t *b, Trio t, qcall_t *mom_snp,
