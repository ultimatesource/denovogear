...
const AlleleDepths::type_info_t
    ...
    {2,   1, "G",     "G",         2, {2,3,1,0}},
    {3,   1, "T",     "T",         3, {3,2,1,0}},
    {4,   2, "AC",    "A,C",       0, {0,1,3,2}},
    {5,   2, "AG",    "A,G",       0, {0,2,3,1}},
    {6,   2, "AT",    "A,T",       0, {0,3,2,1}},
    {7,   2, "CA",    "C,A",       1, {1,0,3,2}},
    {8,   2, "CG",    "C,G",       1, {1,2,3,0}},
    {9,   2, "CT",    "C,T",       1, {1,3,2,0}},
    {10,  2, "GA",    "G,A",       2, {2,0,3,1}},
    {11,  2, "GC",    "G,C",       2, {2,1,3,0}},
    {12,  2, "GT",    "G,T",       2, {2,3,1,0}},
    {13,  2, "TA",    "T,A",       3, {3,0,2,1}},
    {14,  2, "TC",    "T,C",       3, {3,1,2,0}},
    {15,  2, "TG",    "T,G",       3, {3,2,1,0}},
    {16,  3, "ACG",   "A,C,G",     0, {0,1,2,3}},
    {17,  3, "ACT",   "A,C,T",     0, {0,1,3,2}},
    {18,  3, "AGC",   "A,G,C",     0, {0,2,1,3}},
    {19,  3, "AGT",   "A,G,T",     0, {0,2,3,1}},
    {20,  3, "ATC",   "A,T,C",     0, {0,3,1,2}},
    {21,  3, "ATG",   "A,T,G",     0, {0,3,2,1}},
    {22,  3, "CAG",   "C,A,G",     1, {1,0,2,3}},
    {23,  3, "CAT",   "C,A,T",     1, {1,0,3,2}},
    {24,  3, "CGA",   "C,G,A",     1, {1,2,0,3}},
    {25,  3, "CGT",   "C,G,T",     1, {1,2,3,0}},
    {26,  3, "CTA",   "C,T,A",     1, {1,3,0,2}},
    {27,  3, "CTG",   "C,T,G",     1, {1,3,2,0}},
    {28,  3, "GAC",   "G,A,C",     2, {2,0,1,3}},
    {29,  3, "GAT",   "G,A,T",     2, {2,0,3,1}},
    {30,  3, "GCA",   "G,C,A",     2, {2,1,0,3}},
    {31,  3, "GCT",   "G,C,T",     2, {2,1,3,0}},
    {32,  3, "GTA",   "G,T,A",     2, {2,3,0,1}},
    {33,  3, "GTC",   "G,T,C",     2, {2,3,1,0}},
    {34,  3, "TAC",   "T,A,C",     3, {3,0,1,2}},
    {35,  3, "TAG",   "T,A,G",     3, {3,0,2,1}},
    {36,  3, "TCA",   "T,C,A",     3, {3,1,0,2}},
    {37,  3, "TCG",   "T,C,G",     3, {3,1,2,0}},
    {38,  3, "TGA",   "T,G,A",     3, {3,2,0,1}},
    {39,  3, "TGC",   "T,G,C",     3, {3,2,1,0}},
    {40,  4, "ACGT",  "A,C,G,T",   0, {0,1,2,3}},
    {41,  4, "ACTG",  "A,C,T,G",   0, {0,1,3,2}},
    {42,  4, "AGCT",  "A,G,C,T",   0, {0,2,1,3}},
    {43,  4, "AGTC",  "A,G,T,C",   0, {0,2,3,1}},
    {44,  4, "ATCG",  "A,T,C,G",   0, {0,3,1,2}},
    {45,  4, "ATGC",  "A,T,G,C",   0, {0,3,2,1}},
    {46,  4, "CAGT",  "C,A,G,T",   1, {1,0,2,3}},
    {47,  4, "CATG",  "C,A,T,G",   1, {1,0,3,2}},
    {48,  4, "CGAT",  "C,G,A,T",   1, {1,2,0,3}},
    {49,  4, "CGTA",  "C,G,T,A",   1, {1,2,3,0}},
    {50,  4, "CTAG",  "C,T,A,G",   1, {1,3,0,2}},
    {51,  4, "CTGA",  "C,T,G,A",   1, {1,3,2,0}},
    {52,  4, "GACT",  "G,A,C,T",   2, {2,0,1,3}},
    {53,  4, "GATC",  "G,A,T,C",   2, {2,0,3,1}},
    {54,  4, "GCAT",  "G,C,A,T",   2, {2,1,0,3}},
    {55,  4, "GCTA",  "G,C,T,A",   2, {2,1,3,0}},
    {56,  4, "GTAC",  "G,T,A,C",   2, {2,3,0,1}},
    {57,  4, "GTCA",  "G,T,C,A",   2, {2,3,1,0}},
    {58,  4, "TACG",  "T,A,C,G",   3, {3,0,1,2}},
    {59,  4, "TAGC",  "T,A,G,C",   3, {3,0,2,1}},
    {60,  4, "TCAG",  "T,C,A,G",   3, {3,1,0,2}},
    {61,  4, "TCGA",  "T,C,G,A",   3, {3,1,2,0}},
    {62,  4, "TGAC",  "T,G,A,C",   3, {3,2,0,1}},
    {63,  4, "TGCA",  "T,G,C,A",   3, {3,2,1,0}},
    {64,  1, "NA",    "N,A",       4, {0,3,2,1}},
    {65,  1, "NC",    "N,C",       4, {1,3,2,0}},
    {66,  1, "NG",    "N,G",       4, {2,3,1,0}},
    {67,  1, "NT",    "N,T",       4, {3,2,1,0}},
    {68,  2, "NAC",   "N,A,C",     4, {0,1,3,2}},
    {69,  2, "NAG",   "N,A,G",     4, {0,2,3,1}},
    {70,  2, "NAT",   "N,A,T",     4, {0,3,2,1}},
    {71,  2, "NCA",   "N,C,A",     4, {1,0,3,2}},
    {72,  2, "NCG",   "N,C,G",     4, {1,2,3,0}},
    {73,  2, "NCT",   "N,C,T",     4, {1,3,2,0}},
    {74,  2, "NGA",   "N,G,A",     4, {2,0,3,1}},
    {75,  2, "NGC",   "N,G,C",     4, {2,1,3,0}},
    {76,  2, "NGT",   "N,G,T",     4, {2,3,1,0}},
    {77,  2, "NTA",   "N,T,A",     4, {3,0,2,1}},
    {78,  2, "NTC",   "N,T,C",     4, {3,1,2,0}},
    {79,  2, "NTG",   "N,T,G",     4, {3,2,1,0}},
    {80,  3, "NACG",  "N,A,C,G",   4, {0,1,2,3}},
    {81,  3, "NACT",  "N,A,C,T",   4, {0,1,3,2}},
    {82,  3, "NAGC",  "N,A,G,C",   4, {0,2,1,3}},
    {83,  3, "NAGT",  "N,A,G,T",   4, {0,2,3,1}},
    {84,  3, "NATC",  "N,A,T,C",   4, {0,3,1,2}},
    {85,  3, "NATG",  "N,A,T,G",   4, {0,3,2,1}},
    {86,  3, "NCAG",  "N,C,A,G",   4, {1,0,2,3}},
    {87,  3, "NCAT",  "N,C,A,T",   4, {1,0,3,2}},
    {88,  3, "NCGA",  "N,C,G,A",   4, {1,2,0,3}},
    {89,  3, "NCGT",  "N,C,G,T",   4, {1,2,3,0}},
    {90,  3, "NCTA",  "N,C,T,A",   4, {1,3,0,2}},
    {91,  3, "NCTG",  "N,C,T,G",   4, {1,3,2,0}},
    {92,  3, "NGAC",  "N,G,A,C",   4, {2,0,1,3}},
    {93,  3, "NGAT",  "N,G,A,T",   4, {2,0,3,1}},
    {94,  3, "NGCA",  "N,G,C,A",   4, {2,1,0,3}},
    {95,  3, "NGCT",  "N,G,C,T",   4, {2,1,3,0}},
    {96,  3, "NGTA",  "N,G,T,A",   4, {2,3,0,1}},
    {97,  3, "NGTC",  "N,G,T,C",   4, {2,3,1,0}},
    {98,  3, "NTAC",  "N,T,A,C",   4, {3,0,1,2}},
    {99,  3, "NTAG",  "N,T,A,G",   4, {3,0,2,1}},
    {100, 3, "NTCA",  "N,T,C,A",   4, {3,1,0,2}},
    {101, 3, "NTCG",  "N,T,C,G",   4, {3,1,2,0}},
    {102, 3, "NTGA",  "N,T,G,A",   4, {3,2,0,1}},
    {103, 3, "NTGC",  "N,T,G,C",   4, {3,2,1,0}},
    {104, 4, "NACGT", "N,A,C,G,T", 4, {0,1,2,3}},
    {105, 4, "NACTG", "N,A,C,T,G", 4, {0,1,3,2}},
    {106, 4, "NAGCT", "N,A,G,C,T", 4, {0,2,1,3}},
    {107, 4, "NAGTC", "N,A,G,T,C", 4, {0,2,3,1}},
    {108, 4, "NATCG", "N,A,T,C,G", 4, {0,3,1,2}},
    {109, 4, "NATGC", "N,A,T,G,C", 4, {0,3,2,1}},
    {110, 4, "NCAGT", "N,C,A,G,T", 4, {1,0,2,3}},
    {111, 4, "NCATG", "N,C,A,T,G", 4, {1,0,3,2}},
    {112, 4, "NCGAT", "N,C,G,A,T", 4, {1,2,0,3}},
    {113, 4, "NCGTA", "N,C,G,T,A", 4, {1,2,3,0}},
    {114, 4, "NCTAG", "N,C,T,A,G", 4, {1,3,0,2}},
    {115, 4, "NCTGA", "N,C,T,G,A", 4, {1,3,2,0}},
    {116, 4, "NGACT", "N,G,A,C,T", 4, {2,0,1,3}},
    {117, 4, "NGATC", "N,G,A,T,C", 4, {2,0,3,1}},
    {118, 4, "NGCAT", "N,G,C,A,T", 4, {2,1,0,3}},
    {119, 4, "NGCTA", "N,G,C,T,A", 4, {2,1,3,0}},
    {120, 4, "NGTAC", "N,G,T,A,C", 4, {2,3,0,1}},
    {121, 4, "NGTCA", "N,G,T,C,A", 4, {2,3,1,0}},
    {122, 4, "NTACG", "N,T,A,C,G", 4, {3,0,1,2}},
    {123, 4, "NTAGC", "N,T,A,G,C", 4, {3,0,2,1}},
    {124, 4, "NTCAG", "N,T,C,A,G", 4, {3,1,0,2}},
    {125, 4, "NTCGA", "N,T,C,G,A", 4, {3,1,2,0}},
    {126, 4, "NTGAC", "N,T,G,A,C", 4, {3,2,0,1}},
    {127, 4, "NTGCA", "N,T,G,C,A", 4, {3,2,1,0}}
};

const AlleleDepths::type_info_gt_t
    AlleleDepths::type_info_gt_table[128] = {
    {0,   1,  {0,6,3,5,9,2,4,8,7,1}},
    {1,   1,  {1,8,3,7,9,2,4,6,5,0}},
    {2,   1,  {2,9,3,7,8,1,5,6,4,0}},
    {3,   1,  {3,9,2,8,7,1,6,5,4,0}},
    {4,   3,  {0,4,1,6,8,3,5,7,9,2}},
    {5,   3,  {0,5,2,6,9,3,4,7,8,1}},
    {6,   3,  {0,6,3,5,9,2,4,8,7,1}},
    {7,   3,  {1,4,0,8,6,3,7,5,9,2}},
    {8,   3,  {1,7,2,8,9,3,4,5,6,0}},
    {9,   3,  {1,8,3,7,9,2,4,6,5,0}},
    {10,  3,  {2,5,0,9,6,3,7,4,8,1}},
    {11,  3,  {2,7,1,9,8,3,5,4,6,0}},
    {12,  3,  {2,9,3,7,8,1,5,6,4,0}},
    {13,  3,  {3,6,0,9,5,2,8,4,7,1}},
    {14,  3,  {3,8,1,9,7,2,6,4,5,0}},
    {15,  3,  {3,9,2,8,7,1,6,5,4,0}},
    {16,  6,  {0,4,1,5,7,2,6,8,9,3}},
    {17,  6,  {0,4,1,6,8,3,5,7,9,2}},
    {18,  6,  {0,5,2,4,7,1,6,9,8,3}},
    {19,  6,  {0,5,2,6,9,3,4,7,8,1}},
    {20,  6,  {0,6,3,4,8,1,5,9,7,2}},
    {21,  6,  {0,6,3,5,9,2,4,8,7,1}},
    {22,  6,  {1,4,0,7,5,2,8,6,9,3}},
    {23,  6,  {1,4,0,8,6,3,7,5,9,2}},
    {24,  6,  {1,7,2,4,5,0,8,9,6,3}},
    {25,  6,  {1,7,2,8,9,3,4,5,6,0}},
    {26,  6,  {1,8,3,4,6,0,7,9,5,2}},
    {27,  6,  {1,8,3,7,9,2,4,6,5,0}},
    {28,  6,  {2,5,0,7,4,1,9,6,8,3}},
    {29,  6,  {2,5,0,9,6,3,7,4,8,1}},
    {30,  6,  {2,7,1,5,4,0,9,8,6,3}},
    {31,  6,  {2,7,1,9,8,3,5,4,6,0}},
    {32,  6,  {2,9,3,5,6,0,7,8,4,1}},
    {33,  6,  {2,9,3,7,8,1,5,6,4,0}},
    {34,  6,  {3,6,0,8,4,1,9,5,7,2}},
    {35,  6,  {3,6,0,9,5,2,8,4,7,1}},
    {36,  6,  {3,8,1,6,4,0,9,7,5,2}},
    {37,  6,  {3,8,1,9,7,2,6,4,5,0}},
    {38,  6,  {3,9,2,6,5,0,8,7,4,1}},
    {39,  6,  {3,9,2,8,7,1,6,5,4,0}},
    {40,  10, {0,4,1,5,7,2,6,8,9,3}},
    {41,  10, {0,4,1,6,8,3,5,7,9,2}},
    {42,  10, {0,5,2,4,7,1,6,9,8,3}},
    {43,  10, {0,5,2,6,9,3,4,7,8,1}},
    {44,  10, {0,6,3,4,8,1,5,9,7,2}},
    {45,  10, {0,6,3,5,9,2,4,8,7,1}},
    {46,  10, {1,4,0,7,5,2,8,6,9,3}},
    {47,  10, {1,4,0,8,6,3,7,5,9,2}},
    {48,  10, {1,7,2,4,5,0,8,9,6,3}},
    {49,  10, {1,7,2,8,9,3,4,5,6,0}},
    {50,  10, {1,8,3,4,6,0,7,9,5,2}},
    {51,  10, {1,8,3,7,9,2,4,6,5,0}},
    {52,  10, {2,5,0,7,4,1,9,6,8,3}},
    {53,  10, {2,5,0,9,6,3,7,4,8,1}},
    {54,  10, {2,7,1,5,4,0,9,8,6,3}},
    {55,  10, {2,7,1,9,8,3,5,4,6,0}},
    {56,  10, {2,9,3,5,6,0,7,8,4,1}},
    {57,  10, {2,9,3,7,8,1,5,6,4,0}},
    {58,  10, {3,6,0,8,4,1,9,5,7,2}},
    {59,  10, {3,6,0,9,5,2,8,4,7,1}},
    {60,  10, {3,8,1,6,4,0,9,7,5,2}},
    {61,  10, {3,8,1,9,7,2,6,4,5,0}},
    {62,  10, {3,9,2,6,5,0,8,7,4,1}},
    {63,  10, {3,9,2,8,7,1,6,5,4,0}},
    {64,  1,  {0,6,3,5,9,2,4,8,7,1}},
    {65,  1,  {1,8,3,7,9,2,4,6,5,0}},
    {66,  1,  {2,9,3,7,8,1,5,6,4,0}},
    {67,  1,  {3,9,2,8,7,1,6,5,4,0}},
    {68,  3,  {0,4,1,6,8,3,5,7,9,2}},
    {69,  3,  {0,5,2,6,9,3,4,7,8,1}},
    {70,  3,  {0,6,3,5,9,2,4,8,7,1}},
    {71,  3,  {1,4,0,8,6,3,7,5,9,2}},
    {72,  3,  {1,7,2,8,9,3,4,5,6,0}},
    {73,  3,  {1,8,3,7,9,2,4,6,5,0}},
    {74,  3,  {2,5,0,9,6,3,7,4,8,1}},
    {75,  3,  {2,7,1,9,8,3,5,4,6,0}},
    {76,  3,  {2,9,3,7,8,1,5,6,4,0}},
    {77,  3,  {3,6,0,9,5,2,8,4,7,1}},
    {78,  3,  {3,8,1,9,7,2,6,4,5,0}},
    {79,  3,  {3,9,2,8,7,1,6,5,4,0}},
    {80,  6,  {0,4,1,5,7,2,6,8,9,3}},
    {81,  6,  {0,4,1,6,8,3,5,7,9,2}},
    {82,  6,  {0,5,2,4,7,1,6,9,8,3}},
    {83,  6,  {0,5,2,6,9,3,4,7,8,1}},
    {84,  6,  {0,6,3,4,8,1,5,9,7,2}},
    {85,  6,  {0,6,3,5,9,2,4,8,7,1}},
    {86,  6,  {1,4,0,7,5,2,8,6,9,3}},
    {87,  6,  {1,4,0,8,6,3,7,5,9,2}},
    {88,  6,  {1,7,2,4,5,0,8,9,6,3}},
    {89,  6,  {1,7,2,8,9,3,4,5,6,0}},
    {90,  6,  {1,8,3,4,6,0,7,9,5,2}},
    {91,  6,  {1,8,3,7,9,2,4,6,5,0}},
    {92,  6,  {2,5,0,7,4,1,9,6,8,3}},
    {93,  6,  {2,5,0,9,6,3,7,4,8,1}},
    {94,  6,  {2,7,1,5,4,0,9,8,6,3}},
    {95,  6,  {2,7,1,9,8,3,5,4,6,0}},
    {96,  6,  {2,9,3,5,6,0,7,8,4,1}},
    {97,  6,  {2,9,3,7,8,1,5,6,4,0}},
    {98,  6,  {3,6,0,8,4,1,9,5,7,2}},
    {99,  6,  {3,6,0,9,5,2,8,4,7,1}},
    {100, 6,  {3,8,1,6,4,0,9,7,5,2}},
    {101, 6,  {3,8,1,9,7,2,6,4,5,0}},
    {102, 6,  {3,9,2,6,5,0,8,7,4,1}},
    {103, 6,  {3,9,2,8,7,1,6,5,4,0}},
    {104, 10, {0,4,1,5,7,2,6,8,9,3}},
    {105, 10, {0,4,1,6,8,3,5,7,9,2}},
    {106, 10, {0,5,2,4,7,1,6,9,8,3}},
    {107, 10, {0,5,2,6,9,3,4,7,8,1}},
    {108, 10, {0,6,3,4,8,1,5,9,7,2}},
    {109, 10, {0,6,3,5,9,2,4,8,7,1}},
    {110, 10, {1,4,0,7,5,2,8,6,9,3}},
    {111, 10, {1,4,0,8,6,3,7,5,9,2}},
    {112, 10, {1,7,2,4,5,0,8,9,6,3}},
    {113, 10, {1,7,2,8,9,3,4,5,6,0}},
    {114, 10, {1,8,3,4,6,0,7,9,5,2}},
    {115, 10, {1,8,3,7,9,2,4,6,5,0}},
    {116, 10, {2,5,0,7,4,1,9,6,8,3}},
    {117, 10, {2,5,0,9,6,3,7,4,8,1}},
    {118, 10, {2,7,1,5,4,0,9,8,6,3}},
    {119, 10, {2,7,1,9,8,3,5,4,6,0}},
    {120, 10, {2,9,3,5,6,0,7,8,4,1}},
    {121, 10, {2,9,3,7,8,1,5,6,4,0}},
    {122, 10, {3,6,0,8,4,1,9,5,7,2}},
    {123, 10, {3,6,0,9,5,2,8,4,7,1}},
    {124, 10, {3,8,1,6,4,0,9,7,5,2}},
    {125, 10, {3,8,1,9,7,2,6,4,5,0}},
    {126, 10, {3,9,2,6,5,0,8,7,4,1}},
    {127, 10, {3,9,2,8,7,1,6,5,4,0}}
};
