...
#define PEELING_VERBOSE(level)    \
    if(level==0){}                       \
    else if(level==1) std::cerr << "== dng::peeling::" << __FUNCTION__ << " ==" << std::endl;

const int DEBUG_PEELING = 0; //TODO: deal with this in CMAKE later.
