...
You can find an up-to-date version of this file at https://sourceforge.net/p/denovogear/wiki/Home/

### INSTALLATION ###
Requires the newmat11 library, available at http://www.robertnz.net/nm11.htm

cd to newmat, if you have the gnu compiler you can compile using the command
'make -f nm_gnu.mak'

after compiling newmat, change back to the main directory and 
compile with "make". 

NOTE - If you chose to keep the newmat library elsewhere, be sure to edit the denovogear Makefile NEWMAT= definition accordingly. 
