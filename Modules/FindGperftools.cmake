# File Copied from https://raw.githubusercontent.com/m-a-d-n-e-s-s/madness/master/cmake/modules/FindGperftools.cmake
# 
...
if(GPERFTOOLS_FOUND)
  if(NOT TARGET GPERFTOOLS::GPERFTOOLS)
    ...
    if(GPERFTOOLS_LIBRARIES MATCHES "profiler" AND LIBUNWIND_FOUND)
      set_target_properties(GPERFTOOLS::GPERFTOOLS PROPERTIES
        INTERFACE_LINK_LIBRARIES LIBUNWIND::LIBUNWIND)
      add_dependencies(GPERFTOOLS::GPERFTOOLS LIBUNWIND::LIBUNWIND)
    endif()
  endif()
endif()
